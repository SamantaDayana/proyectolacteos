...
def lista_productos(request):
    ...
    return render_to_response('producto/lista_producto.html', {'lista': productos}, context_instance=RequestContext(request))
...
def Modificar_Producto(request, id_prod):
    if request.user.is_authenticated():
        ...
        return render_to_response('producto/modifica_produc.html', {'formulario': formulario},context_instance=RequestContext(request))
    else:
        return HttpResponseRedirect('/')
